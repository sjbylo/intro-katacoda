The Source-To-Image (S2I) tool comes fully integrated with OpenShift.  It is especially useful for OpenShift developers as it can shield them from the details of creating Docker images.  
